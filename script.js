...
const T={
  en:{
    ...
    'pc-d1':'Endpoint defense and SIEM visibility for businesses ready to get serious about security.',
    'pc-d2':'Managed Detection & Response. 24/7 monitoring with full SIEM visibility, AI-driven analytics, and automated response.',
    'pc-d3':'Full SOC operations — dedicated analyst, forensics, compliance reporting, and priority IR.',
  ...
  es:{
    ...
    'pc-n1':'Essential Security','pc-n2':'MDR','pc-n3':'Enterprise SOC',
    'pc-d1':'Defensa de endpoints y visibilidad SIEM para empresas que toman en serio su seguridad.',
    ...
    'pc-d3':'SOC completo — analista dedicado, forense, reportes de cumplimiento y respuesta prioritaria a incidentes.',
  ...
  fr:{
    ...
    'pc-n1':'Essential Security','pc-n2':'MDR','pc-n3':'Enterprise SOC',
    'pc-d1':'Défense des endpoints et visibilité SIEM pour les entreprises qui prennent leur sécurité au sérieux.',
    'pc-d2':'Détection et Réponse Managées. Surveillance 24/7 avec visibilité SIEM complète, analytique IA et réponse automatisée.',
    'pc-d3':'SOC complet — analyste dédié, forensique, rapports conformité et réponse prioritaire aux incidents.',
