...
function toggleLang(){
  // 1. Language swap happens instantly (always works regardless of animation)
    lang=langCycle[lang];
  const t=T[lang];
  ...
  // 2. Cosmetic overlay animation (non-blocking, purely visual)
  ...
  ov.style.opacity = '1';
  // Logo springs in
  setTimeout(function(){ ov.classList.add('logo-in'); }, 150);
  // Logo fades out
  setTimeout(function(){
